package com.snippets.googleCrawler;
...
public class GoogleCrawler {
	 ...
	 * 
	 * @param is the {@link InputStream} objects
	 * 
	...
	public static String getSearchContent(String path) throws Exception {
		...
		/**
		 * User_agent is mandatory otherwise Google will return HTTP response
		 * code: 403
		 */
